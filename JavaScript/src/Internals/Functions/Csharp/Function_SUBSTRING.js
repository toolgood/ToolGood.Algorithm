...
export class Function_SUBSTRING extends Function_3 {
    ...
    Evaluate(engine, tempParameter) {
        ...
        if (args1.IsNotText) {
            args1 = args1.ToText(StringCache.Function_parameter_error2, 'Substring', 1);
            if (args1.IsError) {
                return args1;
            }
        }
        ...
        if (args2.IsNotNumber) {
            args2 = args2.ToNumber(StringCache.Function_parameter_error2, 'Substring', 2);
            if (args2.IsError) {
                return args2;
            }
        }
        ...
        if (args3.IsNotNumber) {
            args3 = args3.ToNumber(StringCache.Function_parameter_error2, 'Substring', 3);
            if (args3.IsError) {
                return args3;
            }
        }
