...
class Function_OCT2HEX extends Function_2 {
    ...
    Evaluate(work, tempParameter) {
        ...
        if (args1.isNotText) {
            args1.toText('Function \'{0}\' parameter {1} is error!', 'OCT2HEX', 1);
            if (args1.isError) {
                return args1;
            }
        }
        ...
        const num = parseInt(args1.textValue, 8).toString(16).toUpperCase();
        if (this.func2 !== null) {
            const args2 = this.func2.Evaluate(work, tempParameter);
            if (args2.isNotNumber) {
                args2.toNumber('Function \'{0}\' parameter {1} is error!', 'OCT2HEX', 2);
                if (args2.isError) {
                    return args2;
                }
            }
