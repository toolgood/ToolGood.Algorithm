...
class Function_AND extends Function_2 {
  ...
  Evaluate(engine, tempParameter)  {
    ...
    if (args1.BooleanValue === false) {
      let args2 = this.func2.Evaluate(engine, tempParameter).ToBoolean(StringCache.Function_parameter_error, 'AND', 2);
      if (args2.IsError) { return args2; }
      return Operand.False;
    }
    return this.func2.Evaluate(engine, tempParameter).ToBoolean(StringCache.Function_parameter_error, 'AND', 2);
  }
}
