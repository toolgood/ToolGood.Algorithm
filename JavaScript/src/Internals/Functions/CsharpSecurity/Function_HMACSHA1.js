...
export class Function_HMACSHA1 extends Function_3 {
    ...
    Evaluate(engine, tempParameter) {
        ...
        if (args1.IsNotText) {
            args1 = args1.ToText(StringCache.Function_parameter_error2, 'HmacSHA1', 1);
            if (args1.IsError) {
                return args1;
            }
        }
        ...
        if (args2.IsNotText) {
            args2 = args2.ToText(StringCache.Function_parameter_error2, 'HmacSHA1', 2);
            if (args2.IsError) {
                return args2;
            }
        }
        ...
        try {
            ...
            if (this.func3 !== undefined && this.func3 !== null) {
                ...
                if (args3.IsNotText) {
                    args3 = args3.ToText(StringCache.Function_parameter_error2, 'HmacSHA1', 3);
                    if (args3.IsError) {
                        return args3;
                    }
                }
            ...
            // 使用Node.js的crypto模块计算HMAC-SHA1哈希值
