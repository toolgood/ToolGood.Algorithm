...
export class Function_SHA1 extends Function_2 {
    ...
    Evaluate(engine, tempParameter) {
        ...
        if (args1.IsNotText) {
            args1 = args1.ToText(StringCache.Function_parameter_error2, "SHA1", 1);
            if (args1.IsError) {
                return args1;
            }
        }
        ...
        try {
            ...
            if (this.func2 !== null) {
                ...
                if (args2.IsNotText) {
                    args2 = args2.ToText(StringCache.Function_parameter_error2, "SHA1", 2);
                    if (args2.IsError) {
                        return args2;
                    }
                }
