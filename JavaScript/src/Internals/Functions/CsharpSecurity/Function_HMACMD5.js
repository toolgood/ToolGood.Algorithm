...
export class Function_HMACMD5 extends Function_3 {
    ...
    Evaluate(work, tempParameter = null) {
        ...
        if (args1.IsNotText) {
            const errorArgs1 = args1.ToText("Function '{0}' parameter {1} is error!", "HMACMD5", 1);
        ...
        if (args2.IsNotText) {
            const errorArgs2 = args2.ToText("Function '{0}' parameter {1} is error!", "HMACMD5", 2);
        ...
        try {
            ...
            if (this.func3 !== null) {
                ...
                if (args3.IsNotText) {
                    const errorArgs3 = args3.ToText("Function '{0}' parameter {1} is error!", "HMACMD5", 3);
            ...
            const hmacHash = CryptoJS.HmacMD5(CryptoJS.lib.WordArray.create(bytes), CryptoJS.lib.WordArray.create(keyBytes));
