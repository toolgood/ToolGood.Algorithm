...
class Function_DATE extends Function_N {
    ...
    Evaluate(engine, tempParameter) {
        ...
        if (args1.IsNotNumber) {
            args1 = args1.ToNumber(StringCache.Function_parameter_error2, "Date", 1);
            if (args1.IsError) { return args1; }
        }
        let args2 = this.funcs[1].Evaluate(engine, tempParameter);
        if (args2.IsNotNumber) {
            args2 = args2.ToNumber(StringCache.Function_parameter_error2, "Date", 2);
            if (args2.IsError) { return args2; }
        }
        let args3 = this.funcs[2].Evaluate(engine, tempParameter);
        if (args3.IsNotNumber) {
            args3 = args3.ToNumber(StringCache.Function_parameter_error2, "Date", 3);
        ...
        if (this.funcs.length == 3) {
            ...
            if (args4.IsNotNumber) {
                args4 = args4.ToNumber(StringCache.Function_parameter_error2, "Date", 4);
            ...
            if (args5.IsNotNumber) {
                args5 = args5.ToNumber(StringCache.Function_parameter_error2, "Date", 5);
            ...
            if (args6.IsNotNumber) {
                args6 = args6.ToNumber(StringCache.Function_parameter_error2, "Date", 6);
