...
注：ToolGood.Algorithm主要以`Decimal`为基础，`Decimal`精度高于`Double`精度，也运算速度慢一点。

注：`Decimal`精度高，不代表没有误差，`Decimal`类型的误差在`1E-28`，`Double`类型的误差在`1E-15`。

注：`Decimal`类型范围小于`Double`类型范围：

`Decimal` 类型范围在  `-79,228,162,514,264,337,593,543,950,335` 到 `79,228,162,514,264,337,593,543,950,335`

`Double` 类型范围在 `-1.79769313486232e308` 到`1.79769313486232e308`
...
3）财务数据、统计数据之中的算法，(注:小部分统计公式会使用`double`类型，建议使用`分`为单位)；
