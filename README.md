...
<table>
   ...
   <tr>
    ...
    <tr>
        <td>CEILING<br>CEIL</td><td>ceiling(数值, 舍入基数)<br>向上舍入（沿绝对值增大的方向）为最接近的 舍入基数 的倍数。</td>
...
<table>
    ...
    <tr>
        <td>LookCeiling<br>LookCeil</td><td>lookCeiling(数值, 数组)<br>在数组中查找大于等于指定值的最小值</td>
