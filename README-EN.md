...
<table>
    <tr><td>function name</td><td>description</td><td>Example</td></tr>
    <tr>
        <td>AddYears ★</td><td>AddYears(date, 数值)<br>增加年。</td> <td></td>
    </tr>
	<tr>
        <td>AddMonths ★</td><td>AddMonths(date, 数值)<br>增加月。</td> <td></td>
    </tr>
	<tr>
        <td>AddDays ★</td><td>AddDays(date, 数值)<br>增加日。</td> <td></td>
    </tr>
    <tr>
        <td>AddHours ★</td><td>AddHours(date, 数值)<br>增加小时。</td> <td></td>
    </tr>
    <tr>
        <td>AddMinutes ★</td><td>AddMinutes(date, 数值)<br>增加分钟。</td> <td></td>
    </tr>
    <tr>
        <td>AddSeconds ★</td><td>AddSeconds(date, 数值)<br>增加秒。</td> <td></td>
    </tr>
    <tr>
        <td>DateValue ★</td><td>DateValue(value, 数值)<br>转成时间<br>
...
<table>
    ...
    <tr>
        <td>BetaDist</td><td>BetaDist(number,分布参数α,分布参数β)<br>返回 Beta 累积分布函数</td>
        <td>BetaDist(0.5,11,22) <br>>>0.97494877</td>
    </tr>
    <tr>
        <td>BetaInv</td><td>BetaInv(number,分布参数α,分布参数β)<br>返回指定 Beta 分布的累积分布函数的反函数</td>
    ...
    <tr>
        <td>gammaDist</td><td>gammaDist(number,分布参数α,分布参数β,returnType：0/1)<br>返回 γ 分布</td>
        <td>gammaDist(0.5,3,4,0) <br>>>0.001723627</td>
    </tr>
    <tr>
        <td>gammaInv</td><td>gammaInv(distributionProbability,分布参数α,分布参数β)<br>返回 γ 累积分布函数的反函数</td>
    ...
    <tr>
        <td>WEIBULL</td><td>weibull(number,分布参数α,分布参数β,returnType：0/1)<br>返回 Weibull 分布</td>
