...
expr:
	...
	| (DEC2BIN | DEC2HEX | DEC2OCT | HEX2BIN | HEX2DEC | HEX2OCT | OCT2BIN | OCT2DEC | OCT2HEX | BIN2OCT | BIN2DEC | BIN2HEX|ISERROR | ISNULL | ISNULLORERROR | TRUNC | ROUND | CEILING | FLOOR | LOG | DELTA | GESTEP | ROMAN | RANK | FIND | FIXED | LEFT | RIGHT | SEARCH | SUBSTITUTE | WEEKDAY | DAYS360 | NETWORKDAYS | WORKDAY | WEEKNUM | AVERAGEIF | SUMIF | IRR | XIRR | DB | DDB | TRIMSTART | TRIMEND | TIMESTAMP | PARAM | DATEVALUE) '(' expr (',' expr)? ')'
