const { Beta } = require('./Distributions/Beta');
const { Binomial } = require('./Distributions/Binomial');
const { Exponential } = require('./Distributions/Exponential');
const { FisherSnedecor } = require('./Distributions/FisherSnedecor');
const { Gamma } = require('./Distributions/Gamma');
const { Hypergeometric } = require('./Distributions/Hypergeometric');
const { LogNormal } = require('./Distributions/LogNormal');
const { NegativeBinomial } = require('./Distributions/NegativeBinomial');
const { Normal } = require('./Distributions/Normal');
const { Poisson } = require('./Distributions/Poisson');
const { StudentT } = require('./Distributions/StudentT');
const { Weibull } = require('./Distributions/Weibull');
const { ArrayStatistics } = require('./Distributions/ArrayStatistics');
const { QuantileDefinition } = require('./Distributions/QuantileDefinition');
const { Statistics } = require('./Distributions/Statistics');
