        ...
        var MyHighlightRules = function () {
            this.$rules = {
                "start": [
                    ...
                    { token: "string", regex: "[Hh][Aa][Ss]\\b|[Hh][Aa][Ss][Kk][Ee][Yy]\\b|[Cc][Oo][Nn][Tt][Aa][Ii][Nn][Ss]\\b|[Cc][Oo][Nn][Tt][Aa][Ii][Nn][Ss][Kk][Ee][Yy]\\b|[Hh][Aa][Ss][Vv][Aa][Ll][Uu][Ee]\\b|[Cc][Oo][Nn][Tt][Aa][Ii][Nn][Ss][Vv][Aa][Ll][Uu][Ee]\\b|[Pp][Aa][Rr][Aa][Mm]\\b|[Pp][Aa][Rr][Aa][Mm][Ee][Tt][Ee][Rr]\\b|[Gg][Ee][Tt][Pp][Aa][Rr][Aa][Mm][Ee][Tt][Ee][Rr]\\b|[Ee][Rr][Rr][Oo][Rr]\\b" },
