...
public class FinancialTest {
    ...
    public void PMT_test() {
        ...
        assertEquals(Math.round(-1037.0321 * 10000) / 10000.0, Math.round(t * 10000) / 10000.0, 0.0001);
    }
    ...
    public void PPMT_test() {
        ...
        assertEquals(Math.round(-970.3654 * 10000) / 10000.0, Math.round(t * 10000) / 10000.0, 0.0001);
    }
    ...
    public void IPMT_test() {
        ...
        assertEquals(Math.round(-66.6667 * 10000) / 10000.0, Math.round(t * 10000) / 10000.0, 0.0001);
    }
    ...
    public void PV_test() {
        ...
        assertEquals(Math.round(9642.90 * 100) / 100.0, Math.round(t * 100) / 100.0, 0.01);
    }
    ...
    public void FV_test() {
        ...
        assertEquals(Math.round(10305.40 * 100) / 100.0, Math.round(t * 100) / 100.0, 0.01);
    }
    ...
    public void NPER_test() {
        ...
        assertEquals(Math.round(10.38 * 100) / 100.0, Math.round(t * 100) / 100.0, 0.01);
    }
    ...
    public void RATE_test() {
        ...
        assertEquals(Math.round(0.2289 * 10000) / 10000.0, Math.round(t * 10000) / 10000.0, 0.0001);
    }
    ...
    public void NPV_test() {
        ...
        assertEquals(Math.round(1188.44 * 100) / 100.0, Math.round(t * 100) / 100.0, 0.01);
    }
    ...
    public void IRR_test() {
        ...
        assertEquals(Math.round(0.0866 * 10000) / 10000.0, Math.round(t * 10000) / 10000.0, 0.0001);
    }
    ...
    public void MIRR_test() {
        ...
        assertEquals(Math.round(0.0987 * 10000) / 10000.0, Math.round(t * 10000) / 10000.0, 0.0001);
    }
    ...
    public void SYD_test() {
        ...
        assertEquals(Math.round(4090.91 * 100) / 100.0, Math.round(t * 100) / 100.0, 0.01);
    }
    ...
    public void DDB_test() {
        ...
        assertEquals(Math.round(384.0 * 100) / 100.0, Math.round(t * 100) / 100.0, 0.01);
    }
    ...
    public void DB_test() {
        ...
        assertEquals(Math.round(319000.0 * 100) / 100.0, Math.round(t * 100) / 100.0, 0.01);
    }
    ...
    public void XNPV_test() {
        ...
        assertEquals(Math.round(2086.65 * 100) / 100.0, Math.round(t * 100) / 100.0, 0.01);
    }
    ...
    public void XIRR_test() {
        ...
        assertEquals(Math.round(0.3734 * 10000) / 10000.0, Math.round(t * 10000) / 10000.0, 0.0001);
    }
}
