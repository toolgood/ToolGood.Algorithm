...
public class mathParser extends Parser {
	...
	public static final int
		...
		GUID=216, MD5=217, SHA1=218, SHA256=219, SHA512=220, HMACMD5=221, HMACSHA1=222, 
		HMACSHA256=223, HMACSHA512=224, TRIMSTART=225, TRIMEND=226, INDEXOF=227, 
		LASTINDEXOF=228, SPLIT=229, JOIN=230, SUBSTRING=231, STARTSWITH=232, ENDSWITH=233, 
		ISNULLOREMPTY=234, ISNULLORWHITESPACE=235, REMOVESTART=236, REMOVEEND=237, 
		JSON=238, LOOKCEILING=239, LOOKFLOOR=240, ARRAY=241, ALGORITHMVERSION=242, 
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"ISREGEX", "GUID", "MD5", "SHA1", "SHA256", "SHA512", "HMACMD5", "HMACSHA1", 
			"HMACSHA256", "HMACSHA512", "TRIMSTART", "TRIMEND", "INDEXOF", "LASTINDEXOF", 
			"SPLIT", "JOIN", "SUBSTRING", "STARTSWITH", "ENDSWITH", "ISNULLOREMPTY", 
			"ISNULLORWHITESPACE", "REMOVESTART", "REMOVEEND", "JSON", "LOOKCEILING", 
			"LOOKFLOOR", "ARRAY", "ALGORITHMVERSION", "ADDYEARS", "ADDMONTHS", "ADDDAYS", 
			"ADDHOURS", "ADDMINUTES", "ADDSECONDS", "TIMESTAMP", "HAS", "HASVALUE", 
			"PARAM", "PARAMETER", "WS", "COMMENT", "LINE_COMMENT"
		};
	}
