...
public class Function_HEX2OCT extends Function_2 {
    public Function_HEX2OCT(FunctionBase func1, FunctionBase func2) {
        super(func1, func2);
    }
    ...
    public Operand Evaluate(AlgorithmEngine work, java.util.function.Function<AlgorithmEngine, String, Operand> tempParameter) {
        ...
        String num = Integer.toOctalString(Integer.parseInt(args1.TextValue(), 16));
        if (func2 != null) {
            Operand args2 = func2.Evaluate(work, tempParameter);
            if (args2.IsNotNumber()) {
                args2 = args2.ToNumber
("Function '{0}' parameter {1} is error!", "HEX2OCT", 2);
                if (args2.IsError()) {
                    return args2;
                }
            }
