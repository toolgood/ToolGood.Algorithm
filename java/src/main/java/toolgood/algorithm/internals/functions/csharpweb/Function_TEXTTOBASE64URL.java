...
public class Function_TEXTTOBASE64URL extends Function_2 {
    public Function_TEXTTOBASE64URL(FunctionBase func1, FunctionBase func2) {
        super(func1, func2);
    }
    ...
    public Operand Evaluate(AlgorithmEngine work, java.util.function.BiFunction<AlgorithmEngine, String, Operand> tempParameter) {
        ...
        if (args1.IsNotText()) {
            args1 = args1.ToText("Function '{0}' parameter {1} is error!", "TextToBase64url", 1);
            if (args1.IsError()) {
                return args1;
            }
        }
        try {
            ...
            if (func2 == null) {
                ...
                if (args2.IsNotText()) {
                    args2 = args2.ToText("Function '{0}' parameter {1} is error!", "TextToBase64url", 2);
                    if (args2.IsError()) {
                        return args2;
                    }
                }
