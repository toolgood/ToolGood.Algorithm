...
("Function '{0}' parameter {1} is error!", "HypgeomDist", 1);
            if (args1.IsError()) {
                return args1;
            }
        }
...
("Function '{0}' parameter {1} is error!", "HypgeomDist", 2);
            if (args2.IsError()) {
                return args2;
            }
        }
...
("Function '{0}' parameter {1} is error!", "HypgeomDist", 3);
            if (args3.IsError()) {
                return args3;
            }
        }
...
("Function '{0}' parameter {1} is error!", "HypgeomDist", 4);
            if (args4.IsError()) {
                return args4;
            }
        }
