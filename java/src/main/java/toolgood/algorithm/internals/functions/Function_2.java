...
public abstract class Function_2 extends Function_1 {
    ...
    protected Operand GetText_2(AlgorithmEngine engine, BiFunction<AlgorithmEngine, String, Operand> tempParameter) throws Exception {
        Operand args2 = func2.Evaluate(engine, tempParameter);
        if (args2.IsText()) return args2;
        return ConvertToText(args2, 2);
    }

    protected Operand GetNumber_2(AlgorithmEngine engine, BiFunction<AlgorithmEngine, String, Operand> tempParameter) throws Exception {
        Operand args2 = func2.Evaluate(engine, tempParameter);
        if (args2.IsNumber()) return args2;
        return ConvertToNumber(args2, 2);
    }

    protected Operand GetDate_2(AlgorithmEngine engine, BiFunction<AlgorithmEngine, String, Operand> tempParameter) throws Exception {
        Operand args2 = func2.Evaluate(engine, tempParameter);
        if (args2.IsDate()) return args2;
        return ConvertToDate(args2, 2);
    }

    protected Operand GetBoolean_2(AlgorithmEngine engine, BiFunction<AlgorithmEngine, String, Operand> tempParameter) throws Exception {
        Operand args2 = func2.Evaluate(engine, tempParameter);
        if (args2.IsBoolean()) return args2;
        return ConvertToBoolean(args2, 2);
    }

    protected Operand GetArray_2(AlgorithmEngine engine, BiFunction<AlgorithmEngine, String, Operand> tempParameter) throws Exception {
        Operand args2 = func2.Evaluate(engine, tempParameter);
