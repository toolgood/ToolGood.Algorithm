...
public class Function_LOGNORMDIST extends Function_3 {
    ...
    public Operand Evaluate(AlgorithmEngine work, java.util.function.BiFunction<AlgorithmEngine, String, Operand> tempParameter) {
        ...
        if (args1.IsNotNumber()) {
            args1 = args1.ToNumber("Function '{0}' parameter {1} is error!", "LognormDist", 1);
            if (args1.IsError()) {
                return args1;
            }
        }
        ...
        if (args2.IsNotNumber()) {
            args2 = args2.ToNumber("Function '{0}' parameter {1} is error!", "LognormDist", 2);
            if (args2.IsError()) {
                return args2;
            }
        }
        ...
        if (args3.IsNotNumber()) {
            args3 = args3.ToNumber("Function '{0}' parameter {1} is error!", "LognormDist", 3);
            if (args3.IsError()) {
                return args3;
            }
        }
