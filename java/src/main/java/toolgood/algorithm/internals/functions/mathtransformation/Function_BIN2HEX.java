...
public class Function_BIN2HEX extends Function_2 {
    public Function_BIN2HEX(FunctionBase func1, FunctionBase func2) {
        super(func1, func2);
    }
    ...
    public Operand Evaluate(AlgorithmEngine work, java.util.function.BiFunction<AlgorithmEngine, String, Operand> tempParameter) {
        ...
        String num = Integer.toHexString(Integer.parseInt(args1.TextValue(), 2)).toUpperCase();
        if (func2 != null) {
