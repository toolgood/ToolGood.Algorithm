...
public class Function_DEC2BIN extends Function_2 {
    public Function_DEC2BIN(FunctionBase func1, FunctionBase func2) {
        super(func1, func2);
    }
...
("Function '{0}' parameter {1} is error!", "DEC2BIN", 1);
            if (args1.IsError()) {
                return args1;
            }
        }
...
("Function '{0}' parameter {1} is error!", "DEC2BIN", 2);
                if (args2.IsError()) {
                    return args2;
                }
            }
