...
public class Exponential {
      /// <summary>
        /// Computes the probability density of the distribution (PDF) at x, i.e. 鈭侾(X 鈮?x)/鈭倄.
        /// </summary>
        /// <param name="rate">The rate (位) parameter of the distribution. Range: 位 鈮?0.</param>
