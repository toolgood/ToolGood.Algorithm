...
public class AlgorithmEngineTest_sum {
    ...
    public void GEOMEAN_test()
    {
        ...
        assertEquals(round(t, 6), round(2.213363839, 6));
    }
    @Test
    public void HARMEAN_test()
    {
        ...
        assertEquals(round(t, 6), round(1.92, 6));
    }
    ...
    public void STDEV_test()
    {
        ...
        assertEquals(round(t, 6), round(1.187734939, 6));
    }
    @Test
    public void STDEVP_test()
    {
        ...
        assertEquals(round(t, 6), round(1.111024302, 6));
    }
    @Test
    public void DEVSQ_test()
    {
        ...
        assertEquals(round(t, 6), round(9.875, 6));
    }
    @Test
    public void VAR_test()
    {
        ...
        assertEquals(round(t, 6), round(1.410714286, 6));
    }
    @Test
    public void VARP_test()
    {
        ...
        assertEquals(round(t, 6), round(1.234375, 6));
    }
    ...
    public void NORMSDIST_test()
    {
        ...
        assertEquals(round(t, 6), round(0.841344746, 6));
    }
    @Test
    public void NORMDIST_test()
    {
        ...
        assertEquals(round(t, 6), round(0.105649774, 6));
        t = engine.TryEvaluate("NORMDIST(3,8,4,0)", 0.0);
        assertEquals(round(t, 6), round(0.045662271, 6));
    }
    @Test
    public void NORMINV_test()
    {
        ...
        assertEquals(round(t, 6), round(10.5248637, 6));
    }
    @Test
    public void NORMSINV_test()
    {
        ...
        assertEquals(round(t, 6), round(-0.524400513, 6));
    }
    @Test
    public void BETADIST_test()
    {
        ...
        assertEquals(round(t, 6), round(0.97494877, 6));
    }
    @Test
    public void BETAINV_test()
    {
        ...
        assertEquals(round(t, 6), round(0.336640759, 6));
    }
    @Test
    public void BINOMDIST_test()
    {
        ...
        assertEquals(round(t, 6), round(0.000817409, 6));
        t = engine.TryEvaluate("BINOMDIST(12,45,0.5,1)", 0.0);
        assertEquals(round(t, 6), round(0.00122945, 6));
    }
    @Test
    public void EXPONDIST_test()
    {
        ...
        assertEquals(round(t, 6), round(0.049787068, 6));
        t = engine.TryEvaluate("EXPONDIST(3,1,1)", 0.0);
        assertEquals(round(t, 6), round(0.950212932, 6));
    }
    @Test
    public void FDIST_test()
    {
        ...
        assertEquals(round(t, 6), round(0.701465776, 6));
    }
    @Test
    public void FINV_test()
    {
        ...
        assertEquals(round(t, 6), round(0.402651432, 6));
    }
    @Test
    public void GAMMADIST_test()
    {
        ...
        assertEquals(round(t, 6), round(0.001723627, 6));
        t = engine.TryEvaluate("GAMMADIST(0.5,3,4,1)", 0.0);
        assertEquals(round(t, 6), round(0.000296478, 6));
    }
    @Test
    public void GAMMAINV_test()
    {
        ...
        assertEquals(round(t, 6), round(6.140176811, 6));
    }
    @Test
    public void GAMMALN_test()
    {
        ...
        assertEquals(round(t, 6), round(1.791759469, 6));
    }
    ...
    public void HYPGEOMDIST_test()
    {
        ...
        assertEquals(round(t, 6), round(0.08715016, 6));
    }
    @Test
    public void LOGINV_test()
    {
        ...
        assertEquals(round(t, 6), round(15.01122624, 6));
    }
    @Test
    public void LOGNORMDIST_test()
    {
        ...
        assertEquals(round(t, 6), round(0.326019201, 6));
    }
    @Test
    public void NEGBINOMDIST_test()
    {
        ...
        assertEquals(round(t, 6), round(0.053463314, 6));
    }
    @Test
    public void POISSON_test()
    {
        ...
        assertEquals(round(t, 6), round(0.082884384, 6));
        t = engine.TryEvaluate("POISSON(23,23,1)", 0.0);
        assertEquals(round(t, 6), round(0.555149936, 6));
    }
    @Test
    public void TDIST_test()
    {
        ...
        assertEquals(round(t, 6), round(0.120925677, 6));
        t = engine.TryEvaluate("TDIST(1.2,24,2)", 0.0);
        assertEquals(round(t, 6), round(0.241851353, 6));
    }
    @Test
    public void TINV_test()
    {
        ...
        assertEquals(round(t, 6), round(1.614756561, 6));
    }
    @Test
    public void WEIBULL_test()
    {
        ...
        assertEquals(round(t, 6), round(0.105160683, 6));
        t = engine.TryEvaluate("WEIBULL(1,2,3,0)", 0.0);
        assertEquals(round(t, 6), round(0.198853182, 6));
        t = engine.TryEvaluate("WEIBULL(-1,2,3,0)", 0.0);
        t = engine.TryEvaluate("WEIBULL(-1,-2,3,0)", 0.0);
        t = engine.TryEvaluate("WEIBULL(-1,-2,-3,0)", 0.0);
    ...
    public void FISHER_test()
    {
        ...
        assertEquals(round(t, 6), round(0.8291140383, 6));
    }
    @Test
    public void FISHERINV_test()
    {
        ...
        assertEquals(round(t, 6), round(0.537049567, 6));
    }
    ...
    public void LARGE_test()
    {
        ...
        assertEquals(round(t, 6), round(3.0, 6));
    }
    @Test
    public void SMALL_test()
    {
        ...
        assertEquals(round(t, 6), round(2.0, 6));
    }
   ...
   @Test
    ...
    public void AVERAGEIF_test()
    {
        ...
        assertEquals(round(t, 6), round(2.833333333, 6));
