...
public class IssuesTest {
    ...
    //     assertEquals(dt, DateTime.Parse("2024-08-01 8:0"));
    // }
    ...
    public void issues_0() {
        ...
        double dt = engine.TryEvaluate("{\"A\": 0.6,\"B\": 0.4,\"C\": 0.6,\"E\": 0.33,\"F\": 0.29,\"Z\": 0.15\n"
                + ",\"EB\": 0.7,\"EE\": 0.65,\"EA\": 0.85,\"AB\": 1.0,\"BC\": 1.0,\"AA\":1.0\n"
                + ",\"EBC\": 1.15,\"BAB\": 1.25,\"BCB\": 1.25,\"BBC\": 1.25,\"CBB\": 1.25,\"EBA\": 1.2,\"AAA\": 1.4}[瓦楞]", 0.0);
        assertEquals(1.0, dt, 0.0);
    }
}
