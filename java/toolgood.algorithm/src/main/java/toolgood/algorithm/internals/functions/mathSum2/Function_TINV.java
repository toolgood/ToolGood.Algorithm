...
final class Function_TINV extends Function_2 {
    ...
    @Override
    public String Name() { return "TInv"; }
    ...
    public Operand Evaluate(AlgorithmEngine engine, BiFunction<AlgorithmEngine, String, Operand> tempParameter) {
        ...
        try {
            return Operand.Create(BigDecimal.valueOf(ExcelFunctions.TInv(p.doubleValue(), degreesFreedom)));
        } catch (Exception e) {
