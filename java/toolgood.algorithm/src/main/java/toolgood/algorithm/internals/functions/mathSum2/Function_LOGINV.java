...
final class Function_LOGINV extends Function_3 {
    ...
    @Override
    public String Name() { return "LogInv"; }
    ...
    public Operand Evaluate(AlgorithmEngine engine, BiFunction<AlgorithmEngine, String, Operand> tempParameter) {
        ...
        if (n3.compareTo(BigDecimal.ZERO) <= 0) {
            return ParameterError(3);
        }
        return Operand.Create(BigDecimal.valueOf(
            ExcelFunctions.LogInv(probability.doubleValue(), args2.NumberValue().doubleValue(), n3.doubleValue())
        ));
    }
