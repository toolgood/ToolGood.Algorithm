...
final class Function_QUARTILE extends Function_2 {

    Function_QUARTILE(FunctionBase[] funcs) {
        super(funcs);
        if (funcs.length != 2) {
    ...
    public Operand Evaluate(AlgorithmEngine engine, BiFunction<AlgorithmEngine, String, Operand> tempParameter) {
        ...
        try {
            return Operand.Create(BigDecimal.valueOf(ExcelFunctions.Quartile(doubleArray, quant)));
        } catch (Exception e) {
            return ParameterError(2);
        }
    }
