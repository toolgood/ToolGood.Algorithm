...
public final class Function_MAX extends Function_N {
        ...
        for (int i = 0; i < args.size(); i++) {
            ...
            if (item.IsArray()) {
                ...
                for (int j = 0; j < array.size(); j++) {
                    ...
                    if (elem.IsNumber()) {
                        if (!found || elem.NumberValue().compareTo(max) > 0) {
                        ...
                        if (FunctionUtil.FlattenToNumberList(elem, list)) {
                            for (int k = 0; k < list.size(); k++) {
                                if (!found || list.get(k).compareTo(max) > 0) {
                                    max = list.get(k);
                                    found = true;
                                }
                            }
                        ...
                        if (!found || converted.NumberValue().compareTo(max) > 0) {
                ...
                if (!found || item.NumberValue().compareTo(max) > 0) {
