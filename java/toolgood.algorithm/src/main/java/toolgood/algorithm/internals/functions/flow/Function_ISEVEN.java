...
public final class Function_ISEVEN extends Function_1 {

    public Function_ISEVEN(FunctionBase[] funcs) {
        super(funcs);
        if (funcs.length != 1) {
    ...
    public Operand Evaluate(AlgorithmEngine engine, BiFunction<AlgorithmEngine, String, Operand> tempParameter) {
        ...
        if (args1.IsNumber()) {
            ...
            if (args1.NumberValue().toBigInteger().mod(java.math.BigInteger.valueOf(2)).equals(java.math.BigInteger.ZERO)) {
                return Operand.True;
            }
        }
