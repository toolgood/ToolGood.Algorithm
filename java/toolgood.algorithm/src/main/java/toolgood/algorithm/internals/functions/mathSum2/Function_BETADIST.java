...
final class Function_BETADIST extends Function_3 {
    ...
    @Override
    public String Name() { return "BetaDist"; }
    ...
    public Operand Evaluate(AlgorithmEngine engine, BiFunction<AlgorithmEngine, String, Operand> tempParameter) {
        ...
        return Operand.Create(BigDecimal.valueOf(
            ExcelFunctions.BetaDist(x.doubleValue(), alpha.doubleValue(), beta.doubleValue())
        ));
    }
