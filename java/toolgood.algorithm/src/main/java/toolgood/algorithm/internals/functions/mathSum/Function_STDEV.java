...
public final class Function_STDEV extends Function_N {
    ...
    @Override
    public String Name() { return "StDev"; }
    ...
    public Operand Evaluate(AlgorithmEngine engine, BiFunction<AlgorithmEngine, String, Operand> tempParameter) {
        ...
        BigDecimal variance = m2.divide(BigDecimal.valueOf(count - 1), MathContext.DECIMAL128);
        return Operand.Create(BigDecimal.valueOf(Math.sqrt(variance.doubleValue())));
    }
