...
final class Function_FISHERINV extends Function_1 {
    public Function_FISHERINV(FunctionBase[] funcs) {
        super(funcs);
        if (funcs.length != 1) {
    ...
    @Override
    public String Name() { return "FisherInv"; }
