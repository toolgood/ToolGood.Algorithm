...
public final class Function_GAMMAINV extends Function_3 {
    public Function_GAMMAINV(FunctionBase[] funcs) {
        super(funcs);
        if (funcs.length != 3) {
    ...
    @Override
    public String Name() { return "GammaInv"; }
    ...
    public Operand Evaluate(AlgorithmEngine engine, BiFunction<AlgorithmEngine, String, Operand> tempParameter) {
        ...
        BigDecimal probability = args1.NumberValue();
        ...
        return Operand.Create(BigDecimal.valueOf(ExcelFunctions.GammaInv(probability.doubleValue(), alpha.doubleValue(), beta.doubleValue())));
    }
