...
final class Function_FDIST extends Function_3 {
    ...
    @Override
    public String Name() { return "FDist"; }
    ...
    public Operand Evaluate(AlgorithmEngine engine, BiFunction<AlgorithmEngine, String, Operand> tempParameter) {
        ...
        return Operand.Create(BigDecimal.valueOf(ExcelFunctions.FDist(x.doubleValue(), degreesFreedom, degreesFreedom2)));
    }
