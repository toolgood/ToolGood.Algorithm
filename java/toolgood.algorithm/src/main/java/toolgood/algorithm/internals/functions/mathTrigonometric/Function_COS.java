...
public final class Function_COS extends Function_1 {
    public Function_COS(FunctionBase[] funcs) {
        super(funcs);
        if (funcs.length != 1) {
    ...
    public Operand Evaluate(AlgorithmEngine engine, BiFunction<AlgorithmEngine, String, Operand> tempParameter) {
        ...
        return Operand.Create(BigDecimal.valueOf(Math.cos(args1.NumberValue().doubleValue())));
    }
