...
final class Function_LOGNORMDIST extends Function_3 {
    ...
    @Override
    public String Name() { return "LogNormDist"; }
    ...
    public Operand Evaluate(AlgorithmEngine engine, BiFunction<AlgorithmEngine, String, Operand> tempParameter) {
        ...
        return Operand.Create(BigDecimal.valueOf(
            ExcelFunctions.LognormDist(x.doubleValue(), args2.NumberValue().doubleValue(), n3.doubleValue())
        ));
    }
