...
final class Function_HMACSHA256 extends Function_2 {
	...
	public Operand Evaluate(AlgorithmEngine engine, BiFunction<AlgorithmEngine, String, Operand> tempParameter) {
		...
		String t = GetHmacSha256String(args1.TextValue().getBytes(StandardCharsets.UTF_8), args2.TextValue());
	...
	private String GetHmacSha256String(byte[] buffer, String secret) {
		try {
			...
			byte[] hashMessage = hmacSha256.doFinal(buffer);
