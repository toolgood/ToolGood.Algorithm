...
final class Function_ATAN2 extends Function_2 {
    ...
    @Override
    public String Name() { return "Atan2"; }
    ...
    public Operand Evaluate(AlgorithmEngine engine, BiFunction<AlgorithmEngine, String, Operand> tempParameter) {
        ...
        return Operand.Create(BigDecimal.valueOf(Math.atan2(args2.NumberValue().doubleValue(), args1.NumberValue().doubleValue())));
    }
