...
namespace ToolGood.Algorithm.Internals.Functions.Operator
{
	internal class Function_OR : Function_2
	{
		...
		public override Operand Evaluate(AlgorithmEngine work, Func<AlgorithmEngine, string, Operand> tempParameter)
		{
			...
			args1 = ConvertToBoolean(args1, "OR", 1);
			if (args1.IsError) { return args1; }
			if(args1.BooleanValue) {
				var args2 = ConvertToBoolean(func2.Evaluate(work, tempParameter), "OR", 2);
				if(args2.IsError) { return args2; }
				return Operand.True;
			}
			return ConvertToBoolean(func2.Evaluate(work, tempParameter), "OR", 2);
		}
