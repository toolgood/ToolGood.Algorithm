...
namespace ToolGood.Algorithm.Internals.Functions.MathSum
{
	internal class Function_NORMDIST : Function_4
    {
        ...
        public override Operand Evaluate(AlgorithmEngine work, Func<AlgorithmEngine, string, Operand> tempParameter)
        {
            ...
            args1 = ConvertToNumber(args1, "NormDist", 1);
            if (args1.IsError) return args1;

            var args2 = func2.Evaluate(work, tempParameter);
            args2 = ConvertToNumber(args2, "NormDist", 2);
            if (args2.IsError) return args2;

            var args3 = func3.Evaluate(work, tempParameter);
            args3 = ConvertToNumber(args3, "NormDist", 3);
            if (args3.IsError) return args3;

            var args4 = func4.Evaluate(work, tempParameter);
            args4 = ConvertToBoolean(args4, "NormDist", 4);
