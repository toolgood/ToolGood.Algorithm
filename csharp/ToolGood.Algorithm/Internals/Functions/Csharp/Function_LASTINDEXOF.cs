...
namespace ToolGood.Algorithm.Internals.Functions.Csharp
{
	internal class Function_LASTINDEXOF : Function_4
	{
		...
		public override Operand Evaluate(AlgorithmEngine work, Func<AlgorithmEngine, string, Operand> tempParameter)
		{
			...
			args1 = FunctionUtil.ConvertToText(args1, "LastIndexOf", 1);
			if(args1.IsError) { return args1; }

			var args2 = func2.Evaluate(work, tempParameter);
			args2 = FunctionUtil.ConvertToText(args2, "LastIndexOf", 2);
			...
			args3 = FunctionUtil.ConvertToNumber(args3, "LastIndexOf", 3);
			...
			args4 = FunctionUtil.ConvertToNumber(args4, "LastIndexOf", 4);
