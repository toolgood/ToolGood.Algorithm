...
namespace ToolGood.Algorithm.Internals.Functions.DateTimes
{
	internal class Function_DATE : Function_N
    {
        ...
        public override Operand Evaluate(AlgorithmEngine work, Func<AlgorithmEngine, string, Operand> tempParameter)
        {
			...
			args1 = ConvertToNumber(args1, "Date", 1);
			if (args1.IsError) { return args1; }

			var args2 = funcs[1].Evaluate(work, tempParameter);
			args2 = ConvertToNumber(args2, "Date", 2);
			if (args2.IsError) { return args2; }

			var args3 = funcs[2].Evaluate(work, tempParameter);
			args3 = ConvertToNumber(args3, "Date", 3);
            ...
            if (funcs.Length == 3) {
                ...
                args4 = ConvertToNumber(args4, "Date", 4);
                ...
                args5 = ConvertToNumber(args5, "Date", 5);
                ...
                args6 = ConvertToNumber(args6, "Date", 6);
