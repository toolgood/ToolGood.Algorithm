...
namespace ToolGood.Algorithm.Internals.Functions.DateTimes
{
	internal class Function_DATE : Function_N
    {
        ...
        {
            var args1 = GetNumber(work, tempParameter, 0);
			if (args1.IsError) { return args1; }

			var args2 = GetNumber(work, tempParameter, 1);
			if (args2.IsError) { return args2; }

			var args3 = GetNumber(work, tempParameter, 2);
            ...
            if (funcs.Length == 3) {
                ...
                var args4 = GetNumber(work, tempParameter, 3);
                ...
                var args5 = GetNumber(work, tempParameter, 4);
                ...
                var args6 = GetNumber(work, tempParameter, 5);
