...
namespace ToolGood.Algorithm.Internals.Visitors
{
	internal sealed class MathFunctionVisitor : AbstractParseTreeVisitor<FunctionBase>, ImathVisitor<FunctionBase>
	{
		...
		public FunctionBase VisitFunction_fun(mathParser.Function_funContext context)
		{
			...
			var funcs = VisitExprs(context.expr());
			switch(type) {
				case mathLexer.ERROR: return new Function_ERROR(funcs[0]);
				case mathLexer.YEAR: return new Function_YEAR(funcs[0]);
				case mathLexer.MONTH: return new Function_MONTH(funcs[0]);
				case mathLexer.DAY: return new Function_DAY(funcs[0]);
				case mathLexer.HOUR: return new Function_HOUR(funcs[0]);
				case mathLexer.MINUTE: return new Function_MINUTE(funcs[0]);
				case mathLexer.SECOND: return new Function_SECOND(funcs[0]);
				case mathLexer.ISNUMBER: return new Function_ISNUMBER(funcs[0]);
				case mathLexer.ISTEXT: return new Function_ISTEXT(funcs[0]);
				case mathLexer.ISNONTEXT: return new Function_ISNONTEXT(funcs[0]);
				case mathLexer.ISLOGICAL: return new Function_ISLOGICAL(funcs[0]);
				case mathLexer.ISEVEN: return new Function_ISEVEN(funcs[0]);
				case mathLexer.ISODD: return new Function_ISODD(funcs[0]);
				case mathLexer.NOT: return new Function_NOT(funcs[0]);
				case mathLexer.ABS: return new Function_ABS(funcs[0]);
				case mathLexer.SIGN: return new Function_SIGN(funcs[0]);
				case mathLexer.SQRT: return new Function_SQRT(funcs[0]);
				case mathLexer.INT: return new Function_INT(funcs[0]);
				case mathLexer.DEGREES: return new Function_DEGREES(funcs[0]);
				case mathLexer.RADIANS: return new Function_RADIANS(funcs[0]);
				case mathLexer.COS: return new Function_COS(funcs[0]);
				case mathLexer.COSH: return new Function_COSH(funcs[0]);
				case mathLexer.SIN: return new Function_SIN(funcs[0]);
				case mathLexer.SINH: return new Function_SINH(funcs[0]);
				case mathLexer.TAN: return new Function_TAN(funcs[0]);
				case mathLexer.TANH: return new Function_TANH(funcs[0]);
				case mathLexer.COT: return new Function_COT(funcs[0]);
				case mathLexer.COTH: return new Function_COTH(funcs[0]);
				case mathLexer.CSC: return new Function_CSC(funcs[0]);
				case mathLexer.CSCH: return new Function_CSCH(funcs[0]);
				case mathLexer.SEC: return new Function_SEC(funcs[0]);
				case mathLexer.SECH: return new Function_SECH(funcs[0]);
				case mathLexer.ACOS: return new Function_ACOS(funcs[0]);
				case mathLexer.ACOSH: return new Function_ACOSH(funcs[0]);
				case mathLexer.ASIN: return new Function_ASIN(funcs[0]);
				case mathLexer.ASINH: return new Function_ASINH(funcs[0]);
				case mathLexer.ATAN: return new Function_ATAN(funcs[0]);
				case mathLexer.ATANH: return new Function_ATANH(funcs[0]);
				case mathLexer.ACOT: return new Function_ACOT(funcs[0]);
				case mathLexer.ACOTH: return new Function_ACOTH(funcs[0]);
				case mathLexer.EVEN: return new Function_EVEN(funcs[0]);
				case mathLexer.ODD: return new Function_ODD(funcs[0]);
				case mathLexer.FACT: return new Function_FACT(funcs[0]);
				case mathLexer.FACTDOUBLE: return new Function_FACTDOUBLE(funcs[0]);
				case mathLexer.EXP: return new Function_EXP(funcs[0]);
				case mathLexer.LN: return new Function_LN(funcs[0]);
				case mathLexer.LOG10: return new Function_LOG10(funcs[0]);
				case mathLexer.SQRTPI: return new Function_SQRTPI(funcs[0]);
				case mathLexer.ERF: return new Function_ERF(funcs[0]);
				case mathLexer.ERFC: return new Function_ERFC(funcs[0]);
				case mathLexer.ARABIC: return new Function_ARABIC(funcs[0]);
				case mathLexer.ASC: return new Function_ASC(funcs[0]);
				case mathLexer.JIS: return new Function_JIS(funcs[0]);
				case mathLexer.CHAR: return new Function_CHAR(funcs[0]);
				case mathLexer.CLEAN: return new Function_CLEAN(funcs[0]);
				case mathLexer.CODE: return new Function_CODE(funcs[0]);
				case mathLexer.UNICHAR: return new Function_UNICHAR(funcs[0]);
				case mathLexer.UNICODE: return new Function_UNICODE(funcs[0]);
				case mathLexer.LEN: return new Function_LEN(funcs[0]);
				case mathLexer.LOWER: return new Function_LOWER(funcs[0]);
				case mathLexer.PROPER: return new Function_PROPER(funcs[0]);
				case mathLexer.TRIM: return new Function_TRIM(funcs[0]);
				case mathLexer.UPPER: return new Function_UPPER(funcs[0]);
				case mathLexer.VALUE: return new Function_VALUE(funcs[0]);
				case mathLexer.TIMEVALUE: return new Function_TIMEVALUE(funcs[0]);
				case mathLexer.NORMSDIST: return new Function_NORMSDIST(funcs[0]);
				case mathLexer.NORMSINV: return new Function_NORMSINV(funcs[0]);
				case mathLexer.FISHER: return new Function_FISHER(funcs[0]);
				case mathLexer.FISHERINV: return new Function_FISHERINV(funcs[0]);
				case mathLexer.GAMMALN: return new Function_GAMMALN(funcs[0]);
				case mathLexer.URLENCODE: return new Function_URLENCODE(funcs[0]);
				case mathLexer.URLDECODE: return new Function_URLDECODE(funcs[0]);
				case mathLexer.HTMLENCODE: return new Function_HTMLENCODE(funcs[0]);
				case mathLexer.HTMLDECODE: return new Function_HTMLDECODE(funcs[0]);
				case mathLexer.BASE64TOTEXT: return new Function_BASE64TOTEXT(funcs[0]);
				case mathLexer.BASE64URLTOTEXT: return new Function_BASE64URLTOTEXT(funcs[0]);
				case mathLexer.TEXTTOBASE64: return new Function_TEXTTOBASE64(funcs[0]);
				case mathLexer.TEXTTOBASE64URL: return new Function_TEXTTOBASE64URL(funcs[0]);
				case mathLexer.ISNULLOREMPTY: return new Function_ISNULLOREMPTY(funcs[0]);
				case mathLexer.ISNULLORWHITESPACE: return new Function_ISNULLORWHITESPACE(funcs[0]);
				case mathLexer.JSON: return new Function_JSON(funcs[0]);
				case mathLexer.T: return new Function_T(funcs[0]);
				case mathLexer.RMB: return new Function_RMB(funcs[0]);
				case mathLexer.MD5: return new Function_MD5(funcs[0]);
				case mathLexer.SHA1: return new Function_SHA1(funcs[0]);
				case mathLexer.SHA256: return new Function_SHA256(funcs[0]);
				case mathLexer.SHA512: return new Function_SHA512(funcs[0]);
				case mathLexer.DEC2BIN: return new Function_DEC2BIN(funcs);
				case mathLexer.DEC2HEX: return new Function_DEC2HEX(funcs);
				case mathLexer.DEC2OCT: return new Function_DEC2OCT(funcs);
				case mathLexer.HEX2BIN: return new Function_HEX2BIN(funcs);
