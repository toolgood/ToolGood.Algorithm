...
public class Function_HMACSHA256 extends Function_3 {
    ...
    public Operand Evaluate(AlgorithmEngine work, Function<String, Operand> tempParameter) {
        ...
        if (args1.IsNotText()) {
            args1 = args1.ToText("Function '{0}' parameter {1} is error!", "HmacSHA256", 1);
            if (args1.IsError()) {
                return args1;
            }
        }
        ...
        if (args2.IsNotText()) {
            args2 = args2.ToText("Function '{0}' parameter {1} is error!", "HmacSHA256", 2);
            if (args2.IsError()) {
                return args2;
            }
        }
        try {
            ...
            if (func3 == null) {
                ...
                if (args3.IsNotText()) {
                    args3 = args3.ToText("Function '{0}' parameter {1} is error!", "HmacSHA256", 3);
                    if (args3.IsError()) {
                        return args3;
                    }
                }
            ...
            String t = getHmacSha256String(buffer, secret);
            return Operand.Create(t);
        } catch (Exception ex) {
            return Operand.Error("Function '{0}' is error!{1}", "HmacSHA256", ex.getMessage());
        }
    }
    ...
    private String getHmacSha256String(byte[] buffer, String secret) throws NoSuchAlgorithmException, InvalidKeyException {
